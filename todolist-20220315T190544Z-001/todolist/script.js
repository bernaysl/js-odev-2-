// Ekleye tıkladıgımızda yeni liste olusturacak
function newElement() {
    let li = document.createElement('li'); //createElement ile nesne olustur
    let inputValue = document.querySelector('#task').value; // secici ile eslesen ilk kaydı bul ve getir
    let text = document.createTextNode(inputValue); //bunun icine metin yazacagız
...
//ogenin üstüne tıklandıgında isaretlenecek
